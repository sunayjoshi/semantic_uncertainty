...
wandb_id = 'YOUR_ID' # 'qztde7ac' # 'hp4uht76' # '419mrddr' # 'rxb5b5pz' # 'shnqvuth' # '98t86157' # 'cl5di0zd' # 'mm4mty1d' # '7jxdj7ke' # 'kf0i33ha' # 'x1wlw3o1' # 'l5repq2v' # 'tgjvxqy5' # 'gokknvd3' # 'xi0fw660' # 'qq4wfsfc' # 'bydbd6hl' # 'YOUR_ID'
if wandb_id == 'YOUR_ID':
